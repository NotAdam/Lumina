namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class Item : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            // col: 59 offset: 0058
            unknown58 = new byte[6];
            unknown58[0] = parser.ReadOffset< byte >( 0x58 );
            unknown58[1] = parser.ReadOffset< byte >( 0x36 );
            unknown58[2] = parser.ReadOffset< byte >( 0x59 );
            unknown58[3] = parser.ReadOffset< byte >( 0x38 );
            unknown58[4] = parser.ReadOffset< byte >( 0x5a );
            unknown58[5] = parser.ReadOffset< byte >( 0x3a );
            ...
            // col: 73 offset: 0060
            unknown60 = new byte[6];
            unknown60[0] = parser.ReadOffset< byte >( 0x60 );
            unknown60[1] = parser.ReadOffset< byte >( 0x42 );
            unknown60[2] = parser.ReadOffset< byte >( 0x61 );
            unknown60[3] = parser.ReadOffset< byte >( 0x44 );
            unknown60[4] = parser.ReadOffset< byte >( 0x62 );
            unknown60[5] = parser.ReadOffset< byte >( 0x46 );
            ...
            // col: 87 offset: 0069
            packed69 = parser.ReadOffset< byte >( 0x69 );
            ...
            // col: 20 offset: 009f
            packed9f = parser.ReadOffset< byte >( 0x9f );

            // col: 38 offset: 00a0
            packeda0 = parser.ReadOffset< byte >( 0xa0 );
