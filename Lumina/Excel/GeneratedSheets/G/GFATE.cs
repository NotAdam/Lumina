namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class GFATE : IExcelRow
    {
        ...
        public bool packed8_2 => ( packed8 & 0x2 ) == 0x2;
        public bool packed8_4 => ( packed8 & 0x4 ) == 0x4;
        ...
        public bool packed14_4 => ( packed14 & 0x4 ) == 0x4;

        // col: 09 offset: 0018
        public uint unknown18;

        // col: 41 offset: 0020
        private byte packed20;
        public bool packed20_1 => ( packed20 & 0x1 ) == 0x1;
        public bool packed20_2 => ( packed20 & 0x2 ) == 0x2;
        public bool packed20_4 => ( packed20 & 0x4 ) == 0x4;
        ...
        public bool packed2c_2 => ( packed2c & 0x2 ) == 0x2;
        public bool packed2c_4 => ( packed2c & 0x4 ) == 0x4;
        ...
        public bool packed44_2 => ( packed44 & 0x2 ) == 0x2;
        public bool packed44_4 => ( packed44 & 0x4 ) == 0x4;

        // col: 13 offset: 0048
        public uint unknown48;

        // col: 45 offset: 0050
        private byte packed50;
        public bool packed50_1 => ( packed50 & 0x1 ) == 0x1;
        public bool packed50_2 => ( packed50 & 0x2 ) == 0x2;
        public bool packed50_4 => ( packed50 & 0x4 ) == 0x4;

        // col: 14 offset: 0054
        public uint unknown54;

        // col: 46 offset: 005c
        private byte packed5c;
        public bool packed5c_1 => ( packed5c & 0x1 ) == 0x1;
        public bool packed5c_2 => ( packed5c & 0x2 ) == 0x2;
        public bool packed5c_4 => ( packed5c & 0x4 ) == 0x4;

        // col: 15 offset: 0060
        public uint unknown60;

        // col: 47 offset: 0068
        private byte packed68;
        public bool packed68_1 => ( packed68 & 0x1 ) == 0x1;
        public bool packed68_2 => ( packed68 & 0x2 ) == 0x2;
        public bool packed68_4 => ( packed68 & 0x4 ) == 0x4;

        // col: 16 offset: 006c
        public uint unknown6c;

        // col: 48 offset: 0074
        private byte packed74;
        public bool packed74_1 => ( packed74 & 0x1 ) == 0x1;
        public bool packed74_2 => ( packed74 & 0x2 ) == 0x2;
        public bool packed74_4 => ( packed74 & 0x4 ) == 0x4;
        ...
        public bool packed80_1 => ( packed80 & 0x1 ) == 0x1;
        public bool packed80_2 => ( packed80 & 0x2 ) == 0x2;
        public bool packed80_4 => ( packed80 & 0x4 ) == 0x4;

        // col: 18 offset: 0084
        public uint unknown84;

        // col: 50 offset: 008c
        private byte packed8c;
        public bool packed8c_1 => ( packed8c & 0x1 ) == 0x1;
        public bool packed8c_2 => ( packed8c & 0x2 ) == 0x2;
        public bool packed8c_4 => ( packed8c & 0x4 ) == 0x4;

        // col: 19 offset: 0090
        public uint unknown90;

        // col: 51 offset: 0098
        private byte packed98;
        public bool packed98_1 => ( packed98 & 0x1 ) == 0x1;
        public bool packed98_2 => ( packed98 & 0x2 ) == 0x2;
        public bool packed98_4 => ( packed98 & 0x4 ) == 0x4;

        // col: 20 offset: 009c
        public uint unknown9c;

        // col: 52 offset: 00a4
        private byte packeda4;
        public bool packeda4_1 => ( packeda4 & 0x1 ) == 0x1;
        public bool packeda4_2 => ( packeda4 & 0x2 ) == 0x2;
        public bool packeda4_4 => ( packeda4 & 0x4 ) == 0x4;

        // col: 21 offset: 00a8
        public uint unknowna8;

        // col: 53 offset: 00b0
        private byte packedb0;
        public bool packedb0_1 => ( packedb0 & 0x1 ) == 0x1;
        public bool packedb0_2 => ( packedb0 & 0x2 ) == 0x2;
        public bool packedb0_4 => ( packedb0 & 0x4 ) == 0x4;
        ...
        // col: 54 offset: 00bc
        private byte packedbc;
        public bool packedbc_1 => ( packedbc & 0x1 ) == 0x1;
        public bool packedbc_2 => ( packedbc & 0x2 ) == 0x2;
        public bool packedbc_4 => ( packedbc & 0x4 ) == 0x4;
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            // col: 41 offset: 0020
            packed20 = parser.ReadOffset< byte >( 0x20 );
            ...
            // col: 45 offset: 0050
            packed50 = parser.ReadOffset< byte >( 0x50 );

            // col: 14 offset: 0054
            unknown54 = parser.ReadOffset< uint >( 0x54 );

            // col: 46 offset: 005c
            packed5c = parser.ReadOffset< byte >( 0x5c );

            // col: 15 offset: 0060
            unknown60 = parser.ReadOffset< uint >( 0x60 );

            // col: 47 offset: 0068
            packed68 = parser.ReadOffset< byte >( 0x68 );

            // col: 16 offset: 006c
            unknown6c = parser.ReadOffset< uint >( 0x6c );

            // col: 48 offset: 0074
            packed74 = parser.ReadOffset< byte >( 0x74 );
            ...
            // col: 50 offset: 008c
            packed8c = parser.ReadOffset< byte >( 0x8c );

            // col: 19 offset: 0090
            unknown90 = parser.ReadOffset< uint >( 0x90 );

            // col: 51 offset: 0098
            packed98 = parser.ReadOffset< byte >( 0x98 );

            // col: 20 offset: 009c
            unknown9c = parser.ReadOffset< uint >( 0x9c );

            // col: 52 offset: 00a4
            packeda4 = parser.ReadOffset< byte >( 0xa4 );

            // col: 21 offset: 00a8
            unknowna8 = parser.ReadOffset< uint >( 0xa8 );

            // col: 53 offset: 00b0
            packedb0 = parser.ReadOffset< byte >( 0xb0 );
            ...
            // col: 54 offset: 00bc
            packedbc = parser.ReadOffset< byte >( 0xbc );
