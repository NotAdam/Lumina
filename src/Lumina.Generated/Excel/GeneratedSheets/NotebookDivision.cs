...
namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class NotebookDivision : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            NotebookDivisionCategory = new LazyRow< NotebookDivisionCategory >( lumina, parser.ReadColumn< byte >( 1 ) );
            CraftOpeningLevel = parser.ReadColumn< byte >( 2 );
            GatheringOpeningLevel = parser.ReadColumn< byte >( 3 );
            QuestUnlock = new LazyRow< Quest >( lumina, parser.ReadColumn< uint >( 4 ) );
