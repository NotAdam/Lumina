...
namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class ChocoboRace : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            ChocoboRaceRank = new LazyRow< ChocoboRaceRank >( lumina, parser.ReadColumn< byte >( 0 ) );
            ChocoboRaceTerritory = new LazyRow< ChocoboRaceTerritory >( lumina, parser.ReadColumn< byte >( 1 ) );
        }
    }
}