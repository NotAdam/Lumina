...
namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class WarpCondition : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            RequiredQuest1 = new LazyRow< Quest >( lumina, parser.ReadColumn< uint >( 2 ) );
            RequiredQuest2 = new LazyRow< Quest >( lumina, parser.ReadColumn< uint >( 3 ) );
            DRequiredQuest3 = new LazyRow< Quest >( lumina, parser.ReadColumn< uint >( 4 ) );
            RequiredQuest4 = new LazyRow< Quest >( lumina, parser.ReadColumn< uint >( 5 ) );
