...
namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class TripleTriadCardResident : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            TripleTriadCardRarity = new LazyRow< TripleTriadCardRarity >( lumina, parser.ReadColumn< byte >( 5 ) );
            TripleTriadCardType = new LazyRow< TripleTriadCardType >( lumina, parser.ReadColumn< byte >( 6 ) );
