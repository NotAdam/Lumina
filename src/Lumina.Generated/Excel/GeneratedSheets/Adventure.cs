...
namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class Adventure : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            Level = new LazyRow< Level >( lumina, parser.ReadColumn< int >( 0 ) );
            MinLevel = parser.ReadColumn< int >( 1 );
            MaxLevel = parser.ReadColumn< byte >( 2 );
            Emote = new LazyRow< Emote >( lumina, parser.ReadColumn< ushort >( 3 ) );
            MinTime = parser.ReadColumn< ushort >( 4 );
            MaxTime = parser.ReadColumn< ushort >( 5 );
            PlaceName = new LazyRow< PlaceName >( lumina, parser.ReadColumn< int >( 6 ) );
