...
namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class GrandCompanyRank : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            QuestMaelstrom = new LazyRow< Quest >( lumina, parser.ReadColumn< int >( 7 ) );
            QuestSerpents = new LazyRow< Quest >( lumina, parser.ReadColumn< int >( 8 ) );
            QuestFlames = new LazyRow< Quest >( lumina, parser.ReadColumn< int >( 9 ) );
