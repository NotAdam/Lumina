...
namespace Lumina.Excel.GeneratedSheets
{
    ...
    public class ENpcBase : IExcelRow
    {
        ...
        public void PopulateData( RowParser parser, Lumina lumina )
        {
            ...
            ModelChara = new LazyRow< ModelChara >( lumina, parser.ReadColumn< ushort >( 35 ) );
            Race = new LazyRow< Race >( lumina, parser.ReadColumn< byte >( 36 ) );
            Gender = parser.ReadColumn< byte >( 37 );
            BodyType = parser.ReadColumn< byte >( 38 );
            Height = parser.ReadColumn< byte >( 39 );
            Tribe = new LazyRow< Tribe >( lumina, parser.ReadColumn< byte >( 40 ) );
            ...
            NpcEquip = new LazyRow< NpcEquip >( lumina, parser.ReadColumn< ushort >( 63 ) );
            Behavior = new LazyRow< Behavior >( lumina, parser.ReadColumn< ushort >( 64 ) );
            ModelMainHand = parser.ReadColumn< ulong >( 65 );
            DyeMainHand = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 66 ) );
            ModelOffHand = parser.ReadColumn< ulong >( 67 );
            DyeOffHand = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 68 ) );
            ModelHead = parser.ReadColumn< uint >( 69 );
            DyeHead = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 70 ) );
            Visor = parser.ReadColumn< bool >( 71 );
            ModelBody = parser.ReadColumn< uint >( 72 );
            DyeBody = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 73 ) );
            ModelHands = parser.ReadColumn< uint >( 74 );
            DyeHands = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 75 ) );
            ModelLegs = parser.ReadColumn< uint >( 76 );
            DyeLegs = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 77 ) );
            ModelFeet = parser.ReadColumn< uint >( 78 );
            DyeFeet = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 79 ) );
            ModelEars = parser.ReadColumn< uint >( 80 );
            DyeEars = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 81 ) );
            ModelNeck = parser.ReadColumn< uint >( 82 );
            DyeNeck = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 83 ) );
            ModelWrists = parser.ReadColumn< uint >( 84 );
            DyeWrists = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 85 ) );
            ModelLeftRing = parser.ReadColumn< uint >( 86 );
            DyeLeftRing = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 87 ) );
            ModelRightRing = parser.ReadColumn< uint >( 88 );
            DyeRightRing = new LazyRow< Stain >( lumina, parser.ReadColumn< byte >( 89 ) );
            Invisibility = parser.ReadColumn< byte >( 90 );
            Balloon = new LazyRow< Balloon >( lumina, parser.ReadColumn< ushort >( 91 ) );
