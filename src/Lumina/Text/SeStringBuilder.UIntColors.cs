...
public sealed partial class SeStringBuilder
{
    ...
    public SeStringBuilder PushColorRgba( uint rgba ) =>
        BeginMacro( MacroCode.Color ).AppendUIntExpression( ( rgba & 0xFF00FF00 ) | ( rgba >> 16 ) | ( ( rgba & 0xFF ) << 16 ) ).EndMacro();
    ...
    /// <remarks>See <a href="https://learn.microsoft.com/en-us/windows/win32/wic/-wic-codec-native-pixel-formats#rgbbgr-color-model">RGB/BGR color model</a>
    /// if the naming gets confusing.</remarks>
    public SeStringBuilder PushColorRgba( Vector4 bgra ) =>
    ...
    public SeStringBuilder PushEdgeColorRgba( uint rgba ) =>
        BeginMacro( MacroCode.EdgeColor ).AppendUIntExpression( ( rgba & 0xFF00FF00 ) | ( rgba >> 16 ) | ( ( rgba & 0xFF ) << 16 ) ).EndMacro();
    ...
    /// <remarks>See <a href="https://learn.microsoft.com/en-us/windows/win32/wic/-wic-codec-native-pixel-formats#rgbbgr-color-model">RGB/BGR color model</a>
    /// if the naming gets confusing.</remarks>
    public SeStringBuilder PushEdgeColorRgba( Vector4 bgra ) =>
        BeginMacro( MacroCode.EdgeColor ).AppendBgraIntExpressionFromRgba( bgra ).EndMacro();
    ...
    public SeStringBuilder PushShadowColorRgba( uint rgba ) =>
        BeginMacro( MacroCode.ShadowColor ).AppendUIntExpression( ( rgba & 0xFF00FF00 ) | ( rgba >> 16 ) | ( ( rgba & 0xFF ) << 16 ) ).EndMacro();
    ...
    /// <remarks>See <a href="https://learn.microsoft.com/en-us/windows/win32/wic/-wic-codec-native-pixel-formats#rgbbgr-color-model">RGB/BGR color model</a>
    /// if the naming gets confusing.</remarks>
    public SeStringBuilder PushShadowColorRgba( Vector4 bgra ) =>
